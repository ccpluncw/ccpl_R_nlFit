...
getOrdinalNumberlineFit2 <- function(data, upperBound, lowerBound = 0,firstEstimate = NULL, memoryLength = NULL, rangeLength = 2, accuracyPercent = 0, numberSensitivity = 1, referencePoints = NULL, loops = 1000, targetOrder = "random", dataTargetCol = "target", dataEstimateCol = "estimate", minimizeStat = 'BIC', pars.n = NULL) {
  ...
  if(validParams == TRUE) {
		...
		df.fitted <- ordinalNumberLineFlex2 (data[[dataTargetCol]], parList, loops=loops)
